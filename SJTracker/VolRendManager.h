...
class VolRendManager
{
	VolRendManager();
public:
	~VolRendManager();

	static VolRendManager* getInst(){ static VolRendManager p; return &p;}
	void  drawFrame (int W, int H, int D, TVec3 pitch);
	void  drawSlices(int W, int H, int D, TVec3 pitch, int sliceNum, TVec3 eyeRay );
};
