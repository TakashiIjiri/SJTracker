...
// SJTracker.h : main header file for the SJTracker application
//
#pragma once
...
// CSJTrackerApp:
// See SJTracker.cpp for the implementation of this class
//

class CSJTrackerApp : public CWinApp
{
public:
	CSJTrackerApp();
